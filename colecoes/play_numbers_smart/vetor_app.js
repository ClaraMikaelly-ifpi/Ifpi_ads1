import { mostrarTexto, mostrarOpcoes, terNumeroPositivo, getNumber, clear, continueComEnter } from "./utils.js";
import { obterMaiorVetor, obterMenorValor, obterMediaVetor, obterPosicaoMaiorValor, obterPosicaoMenorValor, obterNovoVetor, obterSomaVetor, mostrarPositivos, multiplicarVetor, elevarVetor, reduzirValorFracao, substituirNumerosNegativosAleatorio, adicionarNovosValores, resetarVetor, PreencherVetorMinMax, mostrarTodosValores } from "./vetor_funcionabilidades.js";
import { obterTamanhoVetor, mostrarItensVetor  } from "./vetor_utils.js";
...
function main(){
    ...
    while (opcao !== 0){
        ...
        // (7) - media 
            ...
            clear()
            let media = obterMediaVetor(vetor)
        ...
        // (10) - Atualizar valores
            ...
            while(atualizado !== 0){
                ...
                // (1) - multiplicar
                    ...
                    vetor = multiplicarVetor(vetor, valor)
                ...
                // (2) elevar
                    ...
                    vetor = elevarVetor(vetor, expoente)
